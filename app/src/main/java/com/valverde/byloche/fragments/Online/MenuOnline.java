...
public class MenuOnline implements Serializable {
    ...
    private List<MenuDetalle> DetalleMenu;
    ...
    public List<MenuDetalle> getDetalleMenu() {
        return DetalleMenu;
    }

    public void setDetalleMenu(List<MenuDetalle> detalleMenu) {
